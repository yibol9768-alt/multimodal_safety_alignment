...
distribution shift; \citet{pal2024smaug} propose DPOP and
\citet{pipano2026displacement} propose SquaredPO as displacement-resistant
correctives. These analyses motivate \verifyc{}: we use the
